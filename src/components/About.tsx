import { User2, Code2 } from "lucide-react";
...
export function About() {
  ...
  const { description: heroPitch } = content.hero;
  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        ...
        {/* Accroche (déplacée depuis le Hero) */}
        {heroPitch && (
          <p className="max-w-3xl mx-auto mb-12 text-center text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            {heroPitch}
          </p>
        )}
